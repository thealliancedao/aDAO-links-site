...
ok('html: modal has #modal-journey, loads /lib/nft-history.js, app + style cache-busted to 6.5, footer rev 4.36', html.includes('id="modal-journey"') && html.includes('/lib/nft-history.js?v=1.1.1') && html.includes('nft-explorer-app.js?v=6.5') && html.includes('nft-explorer-style.css?v=6.5') && html.includes("rev: '4.36'"));
...
ok('page: 7 event rows, in chain order, sale row last and green-toned', lis.length === 7 && lis[lis.length - 1].classList.contains('jr-sale') && /694 days on the market/.test(lis[lis.length - 1].textContent), lis.map(l => l.className));
