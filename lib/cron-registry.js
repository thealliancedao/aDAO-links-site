 ...
 * 2026-09-22 Lion DAO holders: org-ally-holders-liondao registered (daily 03:40, heartbeat dao-originations/lion-dao/holders-heartbeat.json).
 * ============================================================================= */
(function (root) {
  'use strict';
  ...
  var CRONS = [
    ...
    Object.assign({
      // 2026-09-22 Lion DAO holders: ally-positions/holders.js (same folder, own daily service). pyROAR = every cw20 account
      ...
      description: 'Who holds pyROAR (the frozen burn ledger) and ROAR20 (Solana), every account, with the supply gate Δ — daily',
      sourceUrl: 'https://raw.githubusercontent.com/thealliancedao/dao-originations/main/lion-dao/holders-heartbeat.json',
      tsPath: ['capturedAt'], job: 'org-ally-holders-liondao',
    }, DAILY),
