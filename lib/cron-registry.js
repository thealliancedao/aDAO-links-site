    ...
    return Promise.all(CRONS.map(function (c) {
      ...
      return fetch(url)
        ...
        .then(function (d) {
          ...
          //   - 'stuck'/'error' mean the producer itself is unhealthy → warning
          //   - 'violation'/'partial' are FINDINGS the product is reporting →
          //     freshness stays honest; the finding is surfaced separately.
          var producerBroken = (declared === 'stuck' || declared === 'error');
