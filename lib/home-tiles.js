...
(function (root, factory) {
  ...
  return { VERSION: VERSION, mount: mount, derive: derive, load: loadSources, get: get, fmt: fmt, fill: fill, CSS: CSS, openSheet: openSheet, closeSheets: closeSheets, toggleMenu: toggleMenu, setList: setList, setAct: setAct, _state: state, _M: M };
});
