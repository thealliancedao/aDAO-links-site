...
(function (root, doc) {
  ...
  function mountTenant(el) {
    ...
    function apply(ctx) {
      ...
      if (a) a.setAttribute('aria-label', (t.label || t.slug) + ' home');
      ...
      sel.addEventListener('change', function () { root.CollectionContext.select(sel.value); });
    }
