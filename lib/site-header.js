...
(function (root, doc) {
  ...
  var CSS = [
    ...
    '@media(min-width:768px){.sh-logo img{height:3.25rem}}',
    '.sh-nav{display:none;flex:1;justify-content:center;align-items:center;gap:.5rem}',
    '@media(min-width:768px){.sh-nav{display:flex}}',
    '.sh-tab{min-width:140px;height:3.25rem;display:inline-flex;align-items:center;justify-content:center;text-align:center;text-decoration:none;color:#fff;font-weight:700;font-size:1rem;padding:0 1rem;border-radius:.5rem;background:rgba(31,41,55,.5);border:1px solid #374151;box-shadow:0 10px 15px -3px rgba(0,0,0,.3);transition:transform .15s,background .15s;white-space:nowrap}',
    ...
    '@media(min-width:768px){.sh-globe img{height:3.25rem}}',
    ...
    '.sh-ticker{border-top:1px solid rgba(255,255,255,.05);padding:.35rem 0;min-height:44px;--gecko-widget-height:36px}',
    '.sh-ticker gecko-coin-price-marquee-widget::part(card){padding:.25rem .5rem!important}',
    '@media(max-width:767px){.sh-ticker{min-height:36px;--gecko-widget-height:30px}}',
    '.sh-subnav{background:rgba(10,11,15,.85);border-top:1px solid rgba(255,255,255,.05);border-bottom:1px solid rgba(255,255,255,.06)}',
    '.sh-subwrap{max-width:80rem;margin:0 auto;padding:0 1rem;display:flex;align-items:flex-end;gap:.25rem;overflow-x:auto;scrollbar-width:none}',
    '.sh-subwrap::-webkit-scrollbar{display:none}',
    '.sh-subtab{display:inline-flex;align-items:center;gap:.5rem;padding:.8rem 1.1rem;font-size:1rem;font-weight:600;color:#94a3b8;text-decoration:none;border:0;background:transparent;cursor:pointer;font-family:inherit;white-space:nowrap;border-bottom:2px solid transparent;border-radius:.5rem .5rem 0 0;transition:color .15s,background .15s}',
    '.sh-subtab i{font-size:.95rem;opacity:.85}',
    '.sh-subtab:hover{color:#e2e8f0;background:rgba(255,255,255,.04)}',
    '.sh-subtab.active{color:#fff;background:rgba(255,255,255,.06);border-bottom-color:#67e8f9}',
    '.sh-subtab .sh-badge{font-size:.55rem;font-weight:700;letter-spacing:.06em;padding:.1rem .4rem;border-radius:999px;background:rgba(34,211,238,.15);color:#67e8f9}',
    '.sh-subright{margin-left:auto;display:flex;align-items:center;gap:.6rem;padding:.5rem 0;color:#64748b;font-size:.78rem;font-family:"JetBrains Mono",ui-monospace,Menlo,monospace;white-space:nowrap}',
    '.sh-subright .text-center{text-align:center}.sh-subright .text-xs{font-size:.62rem}.sh-subright .text-lg{font-size:1rem}.sh-subright .text-sm{font-size:.85rem}',
    '@media(max-width:767px){.sh-subtab{padding:.65rem .8rem;font-size:.85rem}.sh-subright{display:none}}',
  ...
  function subnav(items, opts) {
    opts = opts || {}; var host = doc.querySelector(opts.container || '#site-subnav');
