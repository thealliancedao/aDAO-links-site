...
(function (root, doc) {
  ...
  function applyTenantTheme(t, ctx) {
    ...
    var css = ':root{--ally-accent:' + accent + ';--ally-accent2:' + accent2 + ';--ally-bg:' + bg + ';--ally-surface:' + surface + ';--ally-text:' + text + ';--ally-font:' + font + '}' +
      ...
      // page-level containers that share the body's dark class become the page, not a tile; real tiles go dark
      sel + ' .bg-gray-900:not(body){background-color:' + (light ? surface2 : bg) + '!important}' +
