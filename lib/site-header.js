...
(function (root, doc) {
  ...
  function applyTenantTheme(t, ctx) {
    ...
    var css = ':root{--ally-accent:' + accent + ';--ally-accent2:' + accent2 + ';--ally-bg:' + bg + ';--ally-font:' + font + '}' +
      sel + ' body{background:' + bg + '}' +
      ...
      sel + ' .bg-cyan-500,' + sel + ' .bg-cyan-600,' + sel + ' .hover\\:bg-cyan-500:hover,' + sel + ' .hover\\:bg-cyan-600:hover{background-color:' + accent + '!important;color:#111!important}' +
