...
(function (root, doc) {
  ...
  var PAGE_GROUP = {
    'new-here': 'index', 'supporters': 'index', 'member-portfolio': 'tla-stats', 'slippage': 'tla-stats', 'tla-docs': 'tla-stats',
  ...
  function render(opts) {
    ...
    return (wantTicker(opts) ? tickerHtml() : '') +
      ...
      '<div class="sh-right">' + (opts.page === 'new-here' ? '' : '<a href="new-here.html" class="sh-newhere" title="Ten-minute crash course: what the NFT is, how the backing works, the DAO, Terra DeFi in plain words">New here?</a>') + '<span class="sh-globe"><img src="/assets/planets/Terra.PNG" alt=""></span></div>' +
      '</div>' +
