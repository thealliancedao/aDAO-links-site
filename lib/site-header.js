...
(function (root, doc) {
  ...
  var CSS = [
    ...
    '.sh-mobile{display:flex;gap:.4em;overflow-x:auto;padding:0 .75em .6em;scrollbar-width:none;-webkit-overflow-scrolling:touch}',
    '.sh-mobile::-webkit-scrollbar{display:none}',
    '@media(min-width:768px){.sh-mobile{display:none}}',
    '.sh-mtab{flex:1 0 auto;display:flex;flex-direction:column;align-items:center;gap:.2em;padding:.45em .6em;border-radius:.5em;text-decoration:none;color:#94a3b8;font-size:.7em;font-weight:600;background:rgba(31,41,55,.5);border:1px solid #374151}',
    '.sh-mtab i{font-size:.95em}',
    ...
    '.sh-subwrap{max-width:80em;margin:0 auto;padding:0 1em;display:flex;align-items:flex-end;gap:.25em;overflow-x:auto;scrollbar-width:none}',
    '.sh-subwrap::-webkit-scrollbar{display:none}',
    '.sh-subtab{display:inline-flex;align-items:center;gap:.5em;padding:.8em 1.1em;font-size:1em;font-weight:600;color:#94a3b8;text-decoration:none;border:0;background:transparent;cursor:pointer;font-family:inherit;white-space:nowrap;border-bottom:2px solid transparent;border-radius:.5em .5em 0 0;transition:color .15s,background .15s}',
    ...
    '.sh-subright{margin-left:auto;display:flex;align-items:center;gap:.6em;padding:.5em 0;color:#64748b;font-size:.78em;font-family:"JetBrains Mono",ui-monospace,Menlo,monospace;white-space:nowrap}',
    '.sh-subright .text-center{text-align:center}.sh-subright .text-xs{font-size:.62em}.sh-subright .text-lg{font-size:1em}.sh-subright .text-sm{font-size:.85em}',
    '@media(max-width:767px){.sh-subtab{padding:.65em .8em;font-size:.85em}.sh-subright{display:none}}',
