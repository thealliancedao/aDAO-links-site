...
(function (root, doc) {
  ...
  var CSS = [
    ...
    '.sh-tenant.sh-on{display:block}.sh-tenant:focus{outline:none;border-color:#22d3ee}',
    ...
    '.sh-nhcard{display:none}@media(max-width:767px){.sh-nhcard{display:flex;align-items:center;gap:.6em;margin:.35em .75em .5em;padding:.6em .8em;border-radius:.8em;background:linear-gradient(90deg,rgba(34,211,238,.10),rgba(249,115,22,.10));border:1px solid rgba(255,255,255,.1);font-size:13px;color:#e5e7eb}}',
    '.sh-nhcard b{flex:1}.sh-nhcard a{padding:.35em .7em;border-radius:9999px;font-weight:700;text-decoration:none;font-size:12px}.sh-nhcard a.a{background:rgba(34,211,238,.18);color:#67e8f9}.sh-nhcard a.t{background:rgba(249,115,22,.18);color:#fdba74}.sh-nhcard button{background:none;border:0;color:#6b7280;font-size:16px;padding:0 .2em}',
  ...
  function settingsHtml() {
    ...
    return '<div class="sh-sheet" role="dialog" aria-label="App settings"><div class="sh-sheet-card">' +
      ...
      '<div class="sh-sheet-links"><a href="new-here.html"><i class="fas fa-seedling" style="color:#67e8f9"></i> New to aDAO?</a><a href="new-here-tla.html"><i class="fas fa-seedling" style="color:#fdba74"></i> New to TLA?</a></div>' +
  ...
  function applyTenantTheme(t, ctx) {
    ...
    var th = t.theme; var accent = th.accent || '#22d3ee', accent2 = th.accent2 || accent, bg = th.bg || '#0a0b0f';
  ...
  function mount(opts) {
    ...
    try {
      if (isPhone() && !prefsGet().mobileNoticeSeen && !doc.querySelector('.sh-mnote')) {
        doc.body.insertAdjacentHTML('beforeend', '<div class="sh-sheet sh-mnote" role="dialog" aria-label="Mobile notice"><div class="sh-sheet-card">' +
          ...
          '<button type="button" class="sh-wbtn" data-act="mnote-ok" style="justify-content:center;padding:.7em;font-size:14px;color:#67e8f9;border-color:rgba(34,211,238,.4)">Got it</button>' +
          '</div></div>');
    ...
    try {
      ...
      if (pg === 'index' && (opts.page || 'index') === 'index' && !pr.newHereDismissed && isPhone()) {
        el.insertAdjacentHTML('beforeend', '<div class="sh-nhcard"><i class="fas fa-seedling" style="color:#67e8f9"></i><b>New here? Two short starts.</b><a class="a" href="new-here.html">aDAO</a><a class="t" href="new-here-tla.html">TLA</a><button type="button" aria-label="Dismiss" data-act="nh-x">×</button></div>');
