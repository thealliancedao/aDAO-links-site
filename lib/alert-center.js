...
(function (root) {
  'use strict';
  const VERSION = '1.2.0';   // 1.2.0: full text + links on registry cards, marketplace counts every venue event (notable first), props from the corpus with full description / decoded messages / Quick audit
