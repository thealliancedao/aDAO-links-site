/* lib/nft-history.js 1.1.0 (2026-09-18) — 1.1.0: P&L per round trip (USD + LUNA terms) and the current holder's basis; treasury transfers are admin rows
...
(function (root, factory) {
  ...
  return { fold, shardOf, optsFromManifest, amountOf, lunaEq, fmtUsd, fmtAmt, RELIST_H, version: '1.1.0' };
});
