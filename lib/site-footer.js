 ...
 * ecosystem logo banner + builder contact; v3.1: honest legal row.
 * -----------------------------------------------------------------------------
...
(function (root, doc) {
  ...
  // are owed (no asset in /assets/images yet).
  var ECO = [
    ...
    ['Atrium','https://atrium.markets',null],
    ...
    ['Votion','https://votion.money',null],
