 ...
 * v3.4: builder's note + copyable address; ecosystem logo banner + builder contact; v3.3: +Creda, Atrium/Votion logos; v3.1: honest legal row.
 * -----------------------------------------------------------------------------
  ...
  function html(opts) {
    ...
    return '' +
      ...
      '<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-6">' +
        ...
        '<div class="mt-6 pt-4 border-t border-gray-800/70">' +
          '<div class="text-[12px] text-gray-400 leading-relaxed max-w-3xl">' +
            'This site is built, hosted and maintained by one person, out of pocket \u2014 the crons, the chain nodes, the hosting and the hours. ' +
            'If it has been useful to you and you feel like helping keep the lights on, anything sent here goes straight back into keeping it running and building more of it. ' +
            'Any token found in TLA is welcome. Thank you, sincerely.' +
          '</div>' +
          '<div class="mt-2 flex items-center gap-2 flex-wrap text-[11px]">' +
            '<span class="text-gray-500">DeFi_Patriot \u00b7 Terra</span>' +
            '<code id="sf-donate-addr" class="mono text-[11px] text-cyan-300/90 bg-white/[0.04] px-2 py-1 rounded">terra1hr8zsfpch47qygc96c8e6rzkd2t7mafqx77ulw</code>' +
