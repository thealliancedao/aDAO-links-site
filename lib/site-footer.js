...
(function (root, doc) {
  ...
  function renderOthersAsked() {
    ...
    box.setAttribute('style', 'align-self:stretch;border:1px dashed rgba(34,211,238,.25);border-radius:10px;padding:8px 10px;font-size:12px;color:#9ca3af');
    box.innerHTML = '<div style="font-size:10px;text-transform:uppercase;letter-spacing:.12em;color:#67e8f9;margin-bottom:4px">What others asked</div><div id="hd-others-list">loading…</div>';
    log.appendChild(box);
