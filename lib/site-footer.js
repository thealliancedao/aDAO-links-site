...
(function (root, doc) {
  ...
  function html(opts) {
    ...
    var appBtn = opts.appInfo ? '<button id="app-info-trigger" class="hover:text-cyan-300 transition-colors cursor-pointer"><i class="fas fa-mobile-alt text-cyan-400 text-xs"></i> App</button>' : '';
      ...
      '<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-6">' +
        ...
        '<div class="grid grid-cols-2 md:grid-cols-12 gap-8 text-sm text-left">' +
          '<div class="col-span-2 md:col-span-5">' +
            ...
            '<p class="mt-2 text-xs text-gray-500 leading-relaxed max-w-xs">Open on-chain analytics for the Terra Liquidity Alliance and its collections \u2014 built by the community, for the community. Read-only: no wallet, no accounts, no tracking.</p>' +
            ...
            '</div>' +
          '</div>' +
          '<div class="md:col-span-2">' + colH('Site') + siteLinks + '</div>' +
          '<div class="md:col-span-2">' + colH('Ecosystem') + ecoLinks + '</div>' +
          '<div class="md:col-span-3">' + colH('This project') +
            '<a href="https://github.com/thealliancedao" target="_blank" rel="noopener noreferrer" class="block py-0.5 text-gray-400 hover:text-cyan-300 transition-colors">Open source \u2014 org repo</a>' +
            '<a href="' + LOG_BASE + '/' + (PAGE_LOG[opts.page] || 'index-log.md') + '" target="_blank" rel="noopener" class="block py-0.5 text-gray-400 hover:text-cyan-300 transition-colors">Changelog <span class="sf-rev font-mono text-gray-500" id="page-rev">Rev ' + (opts.rev || '\u2014') + (opts.revDate ? ' \u00b7 ' + opts.revDate : '') + '</span></a>' +
            '<a href="' + HUB + '" id="cronHealthTrigger" class="cron-health-trigger block py-0.5" data-overall="unknown" title="View full System Health" style="text-decoration:none"><span class="dot"></span><span class="label">System Health</span></a>' +
            '<a href="https://t.me/The_AllianceDAO" target="_blank" rel="noopener noreferrer" class="block py-0.5 text-gray-400 hover:text-cyan-300 transition-colors">Alliance Contact</a>' +
            (appBtn ? '<div class="py-0.5 text-gray-400">' + appBtn + '</div>' : '') +
          '</div>' +
        '</div>' +
        ...
        '<div class="mt-10 pt-6 border-t border-gray-800/70 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-4 text-left">' +
          ...
          '<div><h5 class="text-[11px] font-bold text-gray-400 mb-1">No wallet, no tracking</h5><p class="text-[11px] leading-relaxed text-gray-600">Read-only. Never asks you to connect a wallet, make an account, or share personal information. Community-built by a community member \u2014 not an official voice of any council or protocol.</p></div>' +
        ...
        '<div class="mt-6 pt-4 border-t border-gray-800/70 flex flex-col sm:flex-row items-center justify-between gap-2 text-[11px] text-gray-600">' +
          ...
          '<span class="font-mono text-gray-700">' + (opts.page || 'page') + '</span>' +
        '</div>' +
